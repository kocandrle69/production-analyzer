...
const T = {
  cs: {
    ...
    uploaded_on: "nahráno",
    quick: ["Co je největší problém teď?","Jaké problémy se opakují?","Jak si stojí efektivita?","Shrň komentáře operátorů","Porovnej závody vs. plán"],
  ...
  en: {
    ...
    quick: ["What's the biggest issue now?","Which problems keep recurring?","How is efficiency across plants?","Summarise operator comments","Compare plants vs. plan"],
